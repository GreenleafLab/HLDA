...
model_dir=/oak/stanford/groups/wjg/skim/projects/LDA/GWAS/gkmSVM/full_models_1000bp 

# Directory for prediction results
result_dir=/oak/stanford/groups/wjg/skim/projects/LDA/GWAS/gkmSVM/snp_explanations
...
do
    ...
    do
        ...
        then
            ...
            sbatch -p wjg,biochem,sfgf,crabtree -t 23:59:00 --mem=12G --cpus-per-task=1 \
