...
pred_dir=/oak/stanford/groups/wjg/skim/projects/LDA/GWAS/gkmSVM/model_predictions
    ...
    do
        ...
        do
            ...
            then
                ...
                sbatch -p wjg,biochem,sfgf,crabtree -t 6:00:00 --mem=10G --cpus-per-task=4 \
                --job-name=${job_header} --output=${true_log} --error=${true_log} --mail-type=FAIL --mail-user=samkim93@stanford.edu \
            ...
            then
                ...
                sbatch -p wjg,biochem,sfgf,crabtree -t 6:00:00 --mem=10G --cpus-per-task=4 \
                --job-name=${job_header} --output=${null_log} --error=${null_log} --mail-type=FAIL --mail-user=samkim93@stanford.edu \
