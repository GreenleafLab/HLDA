...
# From HDA utils 2024/1/23 and edited to include cell name matching
addSeuratGeneExpressionMatrix <- function(archr.proj, gtf.file, seu.file, assay="RNA", matchCellNames = FALSE){
  ...
  if(matchCellNames){
    stringr::str_sub(colnames(sce), -19, -19) <- "#"
  }
